...
class AddStudent extends JFrame{
	...
	public AddStudent(){
		...
		ListenerAdds o = new ListenerAdds(this);

		addbtn = new JButton("Login");
		addbtn.addActionListener(o);
		cp.add(addbtn);
...
class ListenerAdds extends DBConnection implements ActionListener{

	AddStudent as;

	ListenerAdds(AddStudent as){
			this.as = as;
	}

	public void actionPerformed(ActionEvent e1){

		if( e1.getSource() == as.addbtn ){
			...
			String q= "INSERT INTO student SET addmission_num='"+a+"', sssmid='"+b+"',aadhar='"+c+"',name='"+d+"', father_name='"+e+"',mother_name='"+f+"',contact='"+g+"'";
			System.out.print(q);
			//String id = "";
			//ResultSet rs;
			try {
